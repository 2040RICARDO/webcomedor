                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form id="f_lista_nombre_suspender"  method="post" enctype="multipart/form-data" action= "/listanombresuspender"  class="form-horizontal frmentrada" >
                            <input type="hidden" name="_token" id="token" value="<?php echo csrf_token(); ?>">
                                <div class="card card-login">
                                    <div class="card-header text-center" data-background-color="rose">
                                        <h4 class="card-title">Reporte control por nombres</h4>
