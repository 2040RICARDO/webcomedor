...
<html lang="es-ES">
  ...
  <body style="border: 1px solid #000;">
      ...
      <tr align="center">
          <td colspan="" style="font-size: 120%; font-weight: bold;">Reporte suspendidos general</td>
       ...
       <table align="center" border="1">
        ...
        <td align="center" style="font-size: 60%;">{{ $suspender->fecha_inicio}}</td>
         @if($suspender->fecha_conclucion >= $date) 
         <td align="center" style="background: #00e676; color:#000;font-size: 60%;">{{  $suspender->fecha_conclucion}}</td>
        @endif
        @if($suspender->fecha_conclucion < $date) 
         <td align="center" style="background: #dd2c00; color:#fff;font-size: 60%;">{{  $suspender->fecha_conclucion}}</td>
         @endif
      </tr>
