		...
		<div class="col-sm-11 ">
			...
			<div class="wizard-container">
				<div class="card wizard-card" data-color="purple" id="wizard">
					...
					<form id="f_nuevo_actividad"  method="post" enctype="multipart/form-data" action= "/agregar_nuevo_actividad"  class="form-horizontal frmentrada">
						...
						<div class="wizard-navigation">
							<ul>
								<li><a href="#location" data-toggle="tab">Datos de actividad</a></li>
									...
									<div class="col-sm-5 col-sm-offset-1">
										<div class="input-group">
											...
											<div class="form-group label-floating">
												...
												<input type="text" class="form-control" id="" name="actividad" value="">
											</div>
										</div>
									...
									<div class="col-sm-5 ">
										<div class="input-group">
											...
											<div class="form-group label-floating">
												...
												<input type="text" class="form-control datepickercc" id="" name="fecha_actividad" value="">
											</div>
										</div>
									</div>
									<div class="col-sm-5 col-sm-offset-1">
										<div class="input-group">
											...
											<div class="form-group label-floating">
												...
												<textarea class="form-control" placeholder="" rows="5" id="" name="comentario"></textarea>
											</div>
										</div>
