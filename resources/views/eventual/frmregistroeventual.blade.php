<div class="container">
	        <div class="row">
		        <div class="col-sm-11 ">
                    ...
                    <form id="f_nuevo_eventual"  method="post" enctype="multipart/form-data" action= "/agregar_nuevo_eventual"  class="form-horizontal frmentrada">
		                        
                               <input type="hidden" name="_token" id="token" value="<?php echo csrf_token(); ?>">
                               <input type="hidden" name="suspender_id" value="{{$idd}}"/>
                               <input type="hidden" name="comensal_id" value="{{$comensal_idd}}"/>
                               <input type="hidden" name="tarjeta_id" value="{{$tarjeta_idd}}"/>
		                            	...
		                            	<div class="row">
		                                	...
		                                	<div class="input-group">
			                                        ...
			                                        <label class="control-label">Número de ficha</label>
			                                         <input type="text" class="form-control" id="numero" name="numero" value="{{ $ficha }}">
			                                        </div>
												</div>
		                                	...
		                                	<div class="input-group">
			                                        ...
			                                        <label class="control-label">Fecha inicio</label>
			                                         <input type="text" class="form-control datepickercc" id="fecharegistro" name="fecha_inicio" value="{{ $fecha_inicio }}">
			                                        </div>
												</div>
		                                	...
		                                	<div class="input-group">
													...
													<div class="form-group label-floating">
			                                         <label class="control-label">Fecha Final</label>
			                                          <input type="text" class="form-control datepickercc" id="fecharegistro" name="fecha_final" value="{{ $fecha_conclucion }}">
			                                        </div>
												</div>
