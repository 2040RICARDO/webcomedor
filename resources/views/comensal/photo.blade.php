		...
		<div class="col-sm-11 ">
			<div class="wizard-container">
				<div class="card wizard-card" data-color="purple" id="wizard">
					{!!Form::open(['url'=>'photoproduct','method'=>'POST','id'=>'f_nuevo_foto','enctype'=>'multipart/form-data','class'=>'form-horizontal frmentrada'])!!}
					...
					<div class="tab-content">
							...
							<div class="row">
								<div class="col-md-6 ">
									...
									<div class="picture-container">
										<div class="picture">
											<img class="picture-src" src="{{asset('imagenes/')}}/{{$comensal->imagen}}" title="Su fotografía"   id="wizardPicturePreview">
											<input type="file" id="wizard-picture" name="photo" required="true">
											<input type="hidden" name="id" id="inputimages" value="{{ $comensal->id }}">
										</div>
										<h6>{{ $comensal->nombre }}</h6>
									</div>
								</div>
								 <div class="col-md-6 ">
						...
						<div class="wizard-footer">
							<div class="pull-right">
								<br><br><br><br>
								<a type='button' class=' btn-fill btn btn-danger btn-wd' href="javascript:void(0);" onclick="cargarformulario(1);">Cancelar</a>  
